...
public class TransferPage extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        sidebar.setPreferredSize(new Dimension(280, 0)); // Sidebar width optimized for 1200px
        ...
        RoundedButton transferBtn = createActiveMenuButton("Transfer", "/Resources/transfer.png");
    ...
    private RoundedButton createMenuButton(String text, String iconPath) {
        ...
        btn.setFont(new Font("Segoe UI", Font.BOLD, 18)); // Font size increased
